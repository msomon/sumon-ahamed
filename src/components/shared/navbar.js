...
const Navbar = () => {
    ...
    <li  className="hover:bg-green-400 p-2 rounded text-sm font-bold "><Link href="#home">HOME</Link></li>
    <li  className="hover:bg-green-400 p-2 rounded text-sm font-bold "><Link href="#about">ABOUT</Link></li>
